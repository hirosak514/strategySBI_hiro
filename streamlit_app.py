...
def trigger_auto_save():
    ...
    localStorage.setItem('strategist_storage_v2', JSON.stringify(data));
...
def load_from_browser_js():
    ...
    js_code = """
    <script>
    const savedData = localStorage.getItem('strategist_storage_v2');
    if (savedData) {
...
# URLパラメータからデータを復元（JSがデータを運んできた場合）
